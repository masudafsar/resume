...
{\vspace{-10pt}
    \begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt, leftmargin=-1pt]
        \item Improved the performance of a web application by raising the \textbf{Lighthouse scores} from 25 to a minimum of 80.
        \item Reduced the \textbf{bundle size} of the web app from 740 kb to just 270 kb to improve user experience.
