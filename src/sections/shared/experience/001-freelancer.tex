...
{\vspace{-10pt}
    ...
    \end{itemize}
    \texttt{JavaScript} \slashsep \texttt{SCSS} \slashsep \texttt{BootStrap} \slashsep \texttt{jQuery} \slashsep \texttt{Gulp.js} \slashsep \texttt{Git} \slashsep \texttt{C\#} \slashsep \texttt{WinForms} \slashsep \texttt{PHP}
}
