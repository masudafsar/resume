...
%----------------------------------------------------------------------------------------
    ...
    \begin{minipage}[t]{0.5\textwidth}
        ...
        {\huge Front-end Developer} % Career or current job title
    \end{minipage}
    \hfill
...
%----------------------------------------------------------------------------------------
    ...
    \begin{minipage}[t]{0.47\textwidth}
        ...
        \hfill
        \begin{minipage}[t]{0.73\textwidth}
            ESLint, Prettier, Husky, Axios, Moment, Lodash, Three.js, Plop, and jQuery.
        \end{minipage}
        \vspace{4pt}
        ...
        \hfill
        \begin{minipage}[t]{0.73\textwidth}
            Linux, Bash, Git, Restful, GraphQL, Kanban, SCRUM, Confluence, and Jira.
        \end{minipage}
        \vspace{4pt}
