...
%----------------------------------------------------------------------------------------
    ...
    \begin{entrylist}
        ...
        {\vspace{-10pt}
            \begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt, leftmargin=-1pt]
                \item Collaborated with a cross-functional team to develop an online B2B and B2C marketplace which boosted scalability and enhanced customer satisfaction.
            ...
            \end{itemize}
            \texttt{React.js} \slashsep \texttt{Next.js} \slashsep \texttt{TypeScript} \slashsep \texttt{Django} \slashsep \texttt{Docker} \slashsep \texttt{CI/CD}
        }
